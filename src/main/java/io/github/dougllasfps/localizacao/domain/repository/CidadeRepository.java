...
import io.github.dougllasfps.localizacao.domain.repository.projection.CidadeProjection;
...
public interface CidadeRepository extends JpaRepository<Cidade, Long>, JpaSpecificationExecutor<Cidade> {
    ...
    @Query(nativeQuery = true, value = "select id_cidade as id, nome from tb_cidade where nome = :nome")
